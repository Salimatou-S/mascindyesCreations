...
class CommandeController extends AbstractController
{
    ...
    public function index(Request $request,  CommandeRepository $commandeRepository, TailleRepository $tailleRepository, ProduitRepository $produitRepository, ManagerRegistry $doctrine, SessionInterface $session): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) { //si le formulaire est soumis et est valide
           ...
           /*  $confirm=$commandeRepository->findOneBy(['id'=>$idcommande]); */
            return $this->redirectToRoute("app_confirm",['id'=>$idcommande]);
