...
class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        ...
        return $this->redirect($adminUrlGenerator->setController(CommentaireCrudController::class)->generateUrl());//page par defaut du dashboard
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::subMenu('commande','fas fa-list')
        ->setPermission('ROLE_ADMIN')
        ->setSubItems([
